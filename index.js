...
function displayHtmlValues() {
    document.getElementById("sizeTxt").innerHTML = "tamaño de nivel: " + String(document.getElementById("sizeSlider").value);
    document.getElementById("boxTxt").innerHTML = "número de cajas: " + String(document.getElementById("numSlider").value);
}
